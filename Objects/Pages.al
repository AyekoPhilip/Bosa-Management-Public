    ...
    layout
    {
        area(Content)
        {
            ...
            group("Account Controls")
            {
                ...
                field("Cash Transfer Allowed"; "Cash Transfer Allowed") { }
    ...
    layout
    {
        area(Content)
        {
            repeater(General)
            {
                ...
                field("Minmum Contribution"; "Minmum Contribution") { }
            }
        }
        area(Factboxes)
        {
...
page 90032 "Collateral Register"
{
        ...
        area(Content)
        {
            repeater(General)
            {
                ...
                field("Outstanding Value"; OutstandingValue)
                {
                    ...
                    begin
                        LSecurities.Reset();
                        LSecurities.SetRange("Security Code", "Document No");
                        if LSecurities.FindSet() then begin
                            Clear(LoanSecurities);
                            LoanSecurities.LookupMode := true;
                            LoanSecurities.SetTableView(LSecurities);
                            LoanSecurities.RunModal();
                        end;
                    end;
                }
                field(Guarantee; Rec.Guarantee) { }
    ...
    var
        ...
        LoanSecurities: Page "Loan Collateral";
        LSecurities: Record "Loan Securities";
    ...
    layout
    {
        area(Content)
        {
            repeater(General)
            {
                ...
                field("Available Deposits"; "Available Deposits")
                {
                    Editable = isWindowsClient;
                }
                field("Available Self Guarantee"; "Available Self Guarantee")
                {
                    Editable = isWindowsClient;
                }
            }
    ...
    layout
    {
        area(Content)
        {
            repeater(General)
            {
                ...
                field("Suspense Account"; Rec."Suspense Account") { }
                field(SelfEmployment; SelfEmployment) { }
            }
        }
        area(Factboxes)
        {
...
page 90198 "New Guarantor Mgt."
{
    ...
    SourceTableView = where("Portal Status" = const(Submitted), "Approval Status" = const(New));
    layout
    {
        area(Content)
        {
    ...
    layout
    {
        area(Content)
        {
            repeater(GroupName)
            {
                ...
                field("Requested On"; "Requested On")
                {
                    Editable = isSoap;
                }
                field("Responded On"; "Responded On")
    ...
    actions
    {
        area(Processing)
        {
            ...
            action("Uploaded Documents")
            {
                ...
                Image = Document;
                RunObject = page "Document Uploads(RO)";
                RunPageLink = "Parent No" = field("Application No");
            }
        }
    }
...
page 90295 "Portal Economic Subsectors"
{
    PageType = List;
    ApplicationArea = All;
    UsageCategory = Lists;
...
page 90296 "Portal Economic Sub-Subsectors"
{
    PageType = List;
    ApplicationArea = All;
    UsageCategory = Lists;
    ...
    layout
    {
        area(Content)
        {
            ...
            {
                field("Sector Code"; "Sector Code") { }
                field("Sub Sector Code"; "Sub Sector Code") { }
                field("Sub-Subsector Code"; Rec."Sub-Subsector Code") { }
                field("Sub-Subsector Description"; Rec."Sub-Subsector Description") { }
            }
        }
...
page 90297 "Online Loans Lookup"
{
    PageType = List;
    ApplicationArea = All;
    UsageCategory = Lists;
...
page 90298 "Online Guarantor Substitutions"
{
    PageType = List;
    ApplicationArea = All;
    UsageCategory = Lists;
