...
report 90038 "Loan Application"
{
    ...
    dataset
    {
        dataitem("Loan Application"; "Online Loan Application")
        {
            ...
            column(Age; Age) { }
            column(EMail; EMail) { }
            column(WitnessSignature; WitnessRec."Member Signature") { }
            ...
            {
                DataItemLink = "Loan No" = field("Application No");
                DataItemTableView = where(Status = const(Accepted), "Request Type" = const("Guarantor"));
            ...
            begin
                ...
                if WitnessRec.get("Loan Application".Witness) then begin
                    WitnessRec.calcfields("Member Signature");
                    WitnessDate := 0D;
                    WitnessRequest.Reset();
                    WitnessRequest.SetRange("Member No", WitnessRec."Member No.");
                    WitnessRequest.SetRange("Loan No", "Application No");
                    WitnessRequest.SetRange(Status, WitnessRequest.Status::Accepted);
    ...
    var
        ...
        WitnessDate: Date;
        WitnessRequest: Record "Online Guarantor Requests";
        GrossSalary: Decimal;
        EmployerName: Text;
...
report 90043 "FOSA Appraisal"
{
    ...
    var
        ...
        AppraisalAccounts: Record "Appraisal Accounts";
        Net: Decimal;
        Member, Members : Record Members;
        ParameterSetup: Record "Appraisal Parameters";
        TagLine, GuarantorWarning, ThirdRuleWarning, LoanToDepositRatioWarning, RetirementWarning : Text[100];
        SpecialLoan, SpecialLoans2 : Decimal;
        GuarantorPFNo: Code[20];
...
//Fred
report 91007 "Cash With_Deposit Receipt "
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    DefaultLayout = RDLC;
