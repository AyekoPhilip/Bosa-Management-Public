...
table 90023 "Standing Order"
{
    ...
    fields
    {
        ...
        field(15; "EFT Branch Name"; Text[150])
        {
            Editable = false;
        }
        ...
        field(33; "EFT Branch Code"; Code[20])
        {
...
table 90037 "Member Editing"
{
    ...
    fields
    {
        ...
        field(53; "Change Type"; Option)
        {
            OptionMembers = "General Info","Next of KIN",Employment;
            trigger OnValidate()
            begin
                if "Change Type" = "Change Type"::"Next of KIN" then begin
                    Validate("Update KINS", true);
                end;
            end;
        }
        field(54; "Portal Status"; Option)
        {
            OptionMembers = New,Submitted;
        }
    }
    ...
    fields
    {
        ...
        field(3; "Recovery Code"; Code[20])
        {
            ...
            var
                ...
                OnlineLoanApplication, OnlineLoanApplication1 : Record "Online Loan Application";
                Vendor: Record Vendor;
                ProductFactory: Record "Product Factory";
...
table 90090 CreditCueTable
{
    ...
    fields
    {
        ...
        field(10; "Mobile Transactions"; Decimal)
        {
            ...
            FieldClass = FlowField;
            CalcFormula = sum("Mobile Transsactions".Amount where(Posted = const(false)));
        }
    ...
    fields
    {
        ...
        field(3; "Replace With"; Code[20])
        {
            ...
            begin
                //send sms
                Members.Reset();
                Members.SetRange("National ID No", "Replace With");
...
table 90119 "Online Loan Application"
{
    DataClassification = ToBeClassified;
    DataCaptionFields = "Application No", "Member Name", "Product Description", "Approved Amount", "Approval Status";
    LookupPageId = "Online Loans Lookup";
    DrillDownPageId = "Online Loans Lookup";
    fields
    {
        field(1; "Application No"; Code[20])
        {
